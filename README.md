...
程序会根据 Cookie 权限，从高到低逐档尝试，下载能取得的**最高音质**：

| 优先级 | 音质 | 前缀 | 格式 | 说明 |
| --- | --- | --- | --- | --- |
| 1 | 臻品全景声 | Q000 | flac | Dolby Atmos，需超级会员/绿钻豪华版 |
| 2 | 臻品母带 | RS01 | flac | Hi-Res 24bit，需超级会员/绿钻豪华版 |
| 3 | 无损 FLAC | F000 | flac | 需绿钻 VIP |
| 4 | 无损 APE | A000 | ape | 需绿钻 VIP |
| 5 | OGG 640 | O600 | ogg | 高品加强 |
| 6 | 320 MP3 | M800 | mp3 | |
| 7 | OGG 192 | O400 | ogg | |
| 8 | 128 MP3 | M500 | mp3 | 兵底免费 |

> 臻品母带/全景声需要对应等级的付费会员 Cookie；若账号无权限，会自动降到可用的最高档。日志会打印每首实际取得的音质。
